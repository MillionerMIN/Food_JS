...
function slider({
  ...
  const slides = document.querySelectorAll(slide),
        ...
        slidesFeild = document.querySelector(feild),
  ...
  indicators.style.cssText = `
         ...
         list-style: none;
   `;
  slider.append(indicators); //создаем точки
...
function timer(id, deadLine) {
  function getTimeRemaining(endTime) {
    const t = Date.parse(endTime) - Date.parse(new Date()),
          ...
          //получим количество дней из миллисекунд
    hours = Math.floor(t / (1000 * 60 * 60) % 24),
          //получим количество часов из миллисекунд
    minutes = Math.floor(t / 1000 / 60 % 60),
          //получим количество минут из миллисекунд
...
window.addEventListener('DOMContentLoaded', () => {
  const modalTimeId = setTimeout(() => {
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimeId);
  }, 30000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__.default)('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-07-11');
