...
function calc() {
   ...
   if (localStorage.getItem('ratio')) {
      ratio = localStorage.getItem('ration');
   } else {
      ratio = 1.375;
   ...
   function getDynamicInformation(selector) {
      ...
      input.addEventListener('input', () => {
         ...
         if (input.value.match(/\D/g)) {
            input.style.border = '1px solid #f11e72';
         } else {
...
function forms () {
   ...
   function bindPostData(form) {
      ...
      form.addEventListener('submit', (e) => {
         ...
         const formData = new FormData(form); //в input обязательно должен быть отребут name
...
window.addEventListener('DOMContentLoaded', () => {
   const tabs = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js"),     //Tab
      timer = __webpack_require__(/*! ./modules/timer */ "./js/modules/timer.js"),      // Timer
      modal = __webpack_require__(/*! ./modules/modal */ "./js/modules/modal.js"),      // Model window
      cards = __webpack_require__(/*! ./modules/cards */ "./js/modules/cards.js"),      //Используем классы для карточек
      forms = __webpack_require__(/*! ./modules/forms */ "./js/modules/forms.js"),      //Forms
      slider = __webpack_require__(/*! ./modules/slider */ "./js/modules/slider.js"),   // Slider
      calc = __webpack_require__(/*! ./modules/calc */ "./js/modules/calc.js");      // Calc
